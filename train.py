...
class RAWDiffusionModule(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log(
            "train_loss", loss, batch_size=input_data.shape[0], on_step=True, on_epoch=True, prog_bar=True, logger=True
        )
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log(
            "val_loss", loss, batch_size=input_data.shape[0], on_step=True, on_epoch=True, prog_bar=True, logger=True
        )
